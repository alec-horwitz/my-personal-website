    ...
    return (
      <Container inverted attached='bottom' textAlign="center">
        ...
        <Container textAlign="left">
          ...
          <Divider hidden />
          My first encounter with Machine Learning was in college when I was using an R library to compare works of Edgar Allan Poe to a work many scholars believe was written by him, but have not been able to prove through conventional means. The project was not as conclusive as I had hoped, but it offer me my first glimpse into the power of Machine Learning. It’s not hard to envision a world where Machine Learning is used for almost anything. If I learned anything from that project, it’s that Machine Learning is not just something I want to play with, but an invaluable tool I’m determined to master.
          <Divider hidden />
